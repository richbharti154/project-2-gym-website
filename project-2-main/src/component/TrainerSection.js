...
<div className={TrainingStyle.wrap} id='trainingStyle'>
  <h1 className={TrainingStyle.mediaHead} id="append" style={{color:"black"}}>Meet Our Team</h1>
  <p className={TrainingStyle.text} style={{color:"black"}}>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Veniam temporibus delectus magni quaerat quos! Provident totam asperiores, eveniet dolore nisi ad odio. Dignissimos, animi ea quasi ipsum error omnis cum qui dolorem, tempora quibusdam perferendis.</p>
  ...
  <div className={TrainingStyle.griding}>
    ...
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Brock Lesnar -</p>
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Fiteness Coach</p>
    </div>
    <div>
    <img width="300em" src="https://www.sheknows.com/wp-content/uploads/2018/08/fgjixpyyzxr7mlyuu25u.jpeg?w=600" alt="work"/>
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Randy Ortan -</p>
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Crossfit Coach</p>
    </div>
    <div>
    ...
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Roman Reigns -</p>
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Body Building Coach</p>
    </div>
    <div>
    ...
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Sasha Banks -</p>
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Deadlift Coach</p>
    </div>
    </div>
    ...
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Rock -</p>
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Calisthenics</p>
    </div>
    <div>
    ...
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Dean Ambrose -</p>
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Deadlift Coach</p>
    </div>
    <div>
    ...
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Becky Lynch -</p>
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Body Building Coach</p>
    </div>
    <div>
    ...
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Under Tacker -</p>
    <p className={TrainingStyle.mediaText} style={{color:"black"}}>Crossfit Coach</p>
    </div>
    </span>
